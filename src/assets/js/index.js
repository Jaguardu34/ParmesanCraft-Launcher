...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Ca arrive un peu de patience...", "author": "Jaguardu34" },
            { "message": "Réflexion profonde...", "author": "Jaguardu34" },
            { "message": "Chargement de pleins de trucs", "author": "Jaguardu34" }
        ];
